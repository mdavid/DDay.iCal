    ...
    public class ComponentBase : iCalObject
    {
        ...
        static public ComponentBase Create(iCalObject parent, string name)
        {
            switch(name.ToUpper())
            {
                ...
                case "STANDARD": return new DDay.iCal.Components.TimeZone.Standard(parent); break;
                case "DAYLIGHT": return new DDay.iCal.Components.TimeZone.Daylight(parent); break;
